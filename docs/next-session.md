...
- **189 guides** (grows ~1/day via the gated cron, plus/minus the diversification-batch consolidations — see `docs/content-diversification-plan.md` for the current count), 17 categories, daily publish via GitHub Actions. **Video production discontinued 2026-06-15** (built no authority/backlinks — see `docs/video-pipeline.md`).
