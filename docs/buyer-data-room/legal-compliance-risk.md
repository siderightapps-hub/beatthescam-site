# Legal, compliance and risk register

Last reviewed: 2026-07-19

| Area | Current position | Required evidence / action |
|---|---|---|
| Legal/data-controller identity | Site names SideRight Apps; exact person or registered entity and service address not recorded here | Confirm exact legal name, status and suitable contact/service address |
| Content and code ownership | Repository history exists | Create signed ownership declaration and contributor/contractor IP assignments |
| Trademark | No filing recorded | Run clearance search and decide whether to file UK mark before sale process |
...
This is an operational register, not legal advice. Transaction documents and data-transfer decisions should be reviewed by an appropriately qualified adviser when a sale becomes active.
