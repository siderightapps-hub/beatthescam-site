...
What it does:
1. Every Tuesday and Friday at 05:07 UTC (reduced from daily on 2026-07-23), or when triggered manually, GitHub Actions runs.
...
The sibling cron .github/workflows/daily-search-console.yml (05:23 UTC, same Tue/Fri schedule) runs the
