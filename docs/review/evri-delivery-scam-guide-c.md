...
> slug `evri-delivery-scam-guide` - category `sms`  
> Original review copy: `evri-delivery-scam-guide.md`  
> Fact-check sources used: Evri cyber security (`https://www.evri.com/cyber-security`), Evri about us (`https://www.evri.com/about-us`), NCSC text/email reporting (`https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-text-message`, `https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-email`), PSR APP reimbursement (`https://www.psr.org.uk/information-for-consumers/app-fraud-reimbursement-protections/`).  
> Editorial note: quoted texts below are illustrative examples of common scam patterns, not claims that those exact messages or domains are live.

---

## 1. What a fake Evri text looks like

An Evri parcel scam text is a smishing message that imitates the courier so you tap a link and hand over card or personal details. An example of the style is: `Evri: We missed you. Reschedule delivery and pay the GBP 1.79 fee: evri-reschedule[.]example`.
...
## 2. Why Evri texts are easy to fake

Evri launched in March 2022 after Hermes UK rebranded, and scammers still use both the old and new names. Our /guides/hermes-parcel-scam-text-uk/ guide covers the same scam under the old brand.
...
## 3. Signs an Evri text is a scam

- It asks you to pay a small fee to redeliver, reschedule, release, or confirm a parcel.
- It asks you to reply with a letter such as `Y` so a link can be opened.
- The link is not a direct Evri tracking link on `evri.com`, or it uses a lookalike or shortened address.
- It asks for card details, bank details, personal information, or a security code.
...
## 4. How the Evri parcel scam works
...
## 5. How to check an Evri text safely
...
Evri says its texts only send tracking links to its website, and it attempts deliveries up to three times. If the text asks for payment to reschedule a delivery, asks you to install an app, or asks for card or bank details, treat it as a scam. When you are unsure whether a linked site is a copycat, our guide on /guides/is-this-website-a-scam/ walks through the checks.
...
## 7. How to report an Evri scam text (UK)
