# Asset and IP register

Last reviewed: 2026-07-19

| Asset | Current evidence | Owner / account | Transfer position | Open evidence |
|---|---|---|---|---|
...
| Newsletter audience | Resend account | Data controller TBC | Transfer subject to privacy law, contract and purchaser purpose | Subscriber count; lawful transfer assessment; suppression-list handling |
| Analytics/search properties | GA4, GSC and Bing accounts | Account owner TBC | Property/user access transfer where platform permits | Export current admins and property IDs |
| Social profiles | Handles listed in acquisition brief | Account owner TBC | Platform-specific | Current ownership, 2FA and transferability evidence |

“TBC” is deliberate: do not infer the legal owner from a trading name. Before sale preparation, record the exact individual or registered entity and retain signed IP assignments for every contributor.
