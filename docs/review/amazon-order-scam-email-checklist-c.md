...
> **Fact-check copy - checked 26 June 2026**  
> slug `amazon-order-scam-email-checklist` - category `email`  
> Original review copy: `amazon-order-scam-email-checklist.md`  
> Fact-check sources used: Amazon report-a-scam help page (`https://www.amazon.co.uk/gp/help/customer/display.html?nodeId=GRGRY7AQ3LMPXVCV`), Amazon Trustworthy Shopping phishing guidance (`https://trustworthyshopping.aboutamazon.com/en-uk/how-amazons-ai-innovation-helps-protect-customers-from-phishing-scams`), Amazon Scam Prevention (`https://trustworthyshopping.aboutamazon.com/en-uk/scam-prevention`), NCSC email/text reporting (`https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-email`, `https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-text-message`), PSR APP reimbursement (`https://www.psr.org.uk/information-for-consumers/app-fraud-reimbursement-protections/`).  
> Fact-check correction: the draft used Amazon's older `stop-spoofing@amazon.com` address. Amazon's current UK help page says to report suspicious communications to `reportascam@amazon.com`, preferably by sending the suspicious communication as an attachment.  
> Editorial note: quoted texts below are illustrative examples of common phishing patterns, not claims that those exact messages or domains are live.

---

## 1. What a fake Amazon email looks like
...
## 2. Why these Amazon emails fool people
...
## 3. Signs an Amazon email is phishing

- It starts with a generic greeting such as `Dear Customer`, especially when the rest of the email asks you to act urgently.
- The sender address is not a genuine Amazon domain, or the link points to an unfamiliar site.
...
## 4. How the Amazon email scam works
...
If you sent money by UK bank transfer on or after 7 October 2024, mandatory APP fraud reimbursement rules may apply to Faster Payments and CHAPS transfers. The PSR rules include a 13-month claim window, a maximum claim amount of GBP 85,000, possible exclusions, and a possible excess of up to GBP 100. Report the scam to your bank as soon as possible and keep evidence.

If you shared personal details, consider Cifas Protective Registration at `cifas.org.uk` and monitor your credit reports with Experian, Equifax, and TransUnion. Amazon scammers also call people by phone - see our /guides/amazon-phone-call-scam-uk/ guide.


## 7. How to report a fake Amazon email (UK)
