...
> slug `hmrc-tax-refund-text-scam-uk` - category `sms`  
> Original review copy: `hmrc-tax-refund-text-scam-uk.md`  
> Fact-check sources used: HMRC suspicious-message reporting (`https://www.gov.uk/government/organisations/hm-revenue-customs/contact/reporting-fraudulent-emails`), HMRC genuine text-message guidance (`https://www.gov.uk/guidance/check-if-a-text-message-youve-received-from-hmrc-is-genuine`), GOV.UK P800 refund guidance (`https://www.gov.uk/tax-overpayments-and-underpayments/if-youre-due-a-refund`), NCSC text/email reporting (`https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-text-message`, `https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-email`), PSR APP reimbursement (`https://www.psr.org.uk/information-for-consumers/app-fraud-reimbursement-protections/`).  
> Fact-check correction: HMRC can send genuine texts, including some refund-processing confirmations, but GOV.UK says HMRC will not ask for personal or financial information by text.  
...
## 1. What a fake HMRC refund text looks like

An HMRC tax-refund scam text is a smishing message that pretends to be from HM Revenue & Customs so you tap a link and hand over bank, card, or personal details. An example of the style is: `HMRC: You are due a tax refund of GBP 274.50. Claim now: hmrc-taxrefund[.]example`.
...
## 2. Why HMRC refund texts are convincing
...
## 3. Signs an HMRC text is a scam
...
## 4. How the HMRC refund scam works
...
If you shared personal information such as your National Insurance number, consider Cifas Protective Registration at `cifas.org.uk` and monitor your credit reports with Experian, Equifax, and TransUnion. Government-impersonation texts also target drivers - see our /guides/dvla-vehicle-tax-text-scam/ guide.


## 7. How to report an HMRC scam text (UK)
