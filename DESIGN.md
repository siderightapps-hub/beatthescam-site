...
At 1100px, multi-column content becomes a single, linear reading flow and sticky sidebars return to normal document order. At 760px, navigation folds into a panel menu and the hero gains a little more top clearance. The newsletter begins its one-column transition earlier, at 860px, so its form remains comfortably usable.
