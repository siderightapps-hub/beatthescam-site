...
> slug `royal-mail-text-scam-uk` - category `sms`  
> Original review copy: `royal-mail-text-scam-uk.md`  
> Fact-check sources used: Royal Mail scam protection (`https://www.royalmail.com/help/scam-protection`), NCSC text/email reporting (`https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-text-message`, `https://www.ncsc.gov.uk/collection/phishing-scams/report-scam-email`), PSR APP reimbursement (`https://www.psr.org.uk/information-for-consumers/app-fraud-reimbursement-protections/`).  
> Fact-check correction: Royal Mail can send SMS/email customs-fee notifications, so this copy avoids the inaccurate blanket claim that a genuine Royal Mail fee is never notified by text.  
...
## 1. What a fake Royal Mail text looks like

A Royal Mail scam text is a smishing message that pretends to be from Royal Mail so you tap a link and hand over card or personal details. An example of the style is: `Royal Mail: Your parcel has an unpaid shipping fee of GBP 2.99. Pay to reschedule delivery: royalmail-redelivery[.]example`.
...
## 2. Why Royal Mail texts are easy to fake
...
## 3. Signs a Royal Mail text is a scam
...
## 4. How the Royal Mail fee scam works
...
## 7. How to report a Royal Mail scam text (UK)
