...
> **▶ RESUME (handoff 2026-06-28):** Batches 1–4 are **merged & live** (21 pages) plus the fact-checked `fake-travel-agent-scam-uk` cron guide (PR #20, merged). **Batch 5 is fact-checked & PR'd — [PR #22](https://github.com/siderightapps-hub/beatthescam-site/pull/22), awaiting merge** (5 pages, gate 0/0, build-verified; all high-stakes claims independently re-verified against psr.org.uk / gov.uk / Stop Scams UK this session): `bank-transfer-scam-uk` (the "safe account" APP con), `hmrc-tax-rebate-email-scam`, `recruitment-agency-scam-uk`, `data-entry-job-scam-uk`, `universal-credit-scam-uk` (the advance-loan scam). Merging PR #22 publishes them (Netlify auto-deploy); these 5 slugs already exist on `main`, so `tweet-on-publish` (diff-based, new-slugs-only) won't re-tweet them. **Remaining tail after batch 5:** `whatsapp-scam-family-message-uk`, `military-romance-scam-uk`, `dvla-scam-email-awareness`, `autotrader-car-scam-uk`, `amazon-delivery-scam-text-uk`.
